document.addEventListener("DOMContentLoaded", function () {
    ...
    let partnerName = "Mary"; // Replace with dynamic value
    ...
    function revealChoices() {
        ...
        setTimeout(() => {
            typeWriterEffect(typedTextElement, "Will you be my Forgive me?");
    ...
    yesButton.addEventListener("click", function () {
        questionText.innerHTML = `<span class="partner-name">${partnerName}</span><br><span class="love-text">I love you so much thank you ❤️</span>`;
    ...
    noButton.addEventListener("click", function () {
        ...
        if (noClickCount < 5) {
            ...
            questionText.innerHTML += `<br><span class="no-choice-text">Can you please say yes?</span>`;
        }
    });
